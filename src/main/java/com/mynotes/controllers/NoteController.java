...
public class NoteController {
    ...
    public ResponseEntity createNote(
        ...
        // CREATE NOTE:
        int result = noteService.createNote(user_id, title, content);
    ...
    public ResponseEntity updateNoteById(
            @RequestBody UpdateNoteRequest updateNoteRequest, HttpServletRequest request
    ) {
        // GET USER ID:
        Integer user_id = extractUserIDFromTokenHelper.getUserIdFromToken(request);
    ...
    public ResponseEntity deleteNoteById(
            @RequestParam("note_id") String note_id, HttpServletRequest request
    ) {
        Integer user_id = extractUserIDFromTokenHelper.getUserIdFromToken(request);
