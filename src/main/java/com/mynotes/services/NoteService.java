...
public class NoteService {
    ...
    public int createNote(int user_id, String title, String content) {
        return noteRepository.createNote(user_id, title, content);
    }
    // END OF CREATE NOTE SERVICE METHOD.

    public int updateNoteIdByUserId(String title, String content, int noted_id, int user_id) {
        return noteRepository.updateNoteByNoteIdAndUserId(title, content, noted_id, user_id);
    }
